...
{% for repo in repos %}
**[{% if repo.archived %}{% octicon archive height:16 aria-label:"Archived repository:" fill:currentcolor %}&nbsp;{% endif %}{% if repo.fork %}{% octicon repo-forked height:16 aria-label:"Forked repository:" fill:currentcolor %}&nbsp;{% endif %}{{ repo.name }}]({% if repo.homepage and repo.homepage != "" %}{{ repo.homepage }}{% else %}{{ repo.html_url }}{% endif %})** 
